...
const authReducer = (state = initialState, action) => {
  switch (action.type) {
    case 'AUTH_START':
      return { ...state, loading: true, error: false, userAlreadyExists: false };
    case 'AUTH_SUCCESS':
    ...
    case 'RESET_USER_ALREADY_EXISTS':
      return { ...state, userAlreadyExists: false, invalidEmailorPassword: false, wrongoldpassword: false };
    ...
    case 'ADD_PEOPLE_SUCCESS':
      return {
        ...
        authData: {
          ...
          user: {
            ...state.authData.user,
            peopleAdded: [...state.authData.user.peopleAdded, action.payload],
          },
        },
      };
    case 'LOGOUT':
